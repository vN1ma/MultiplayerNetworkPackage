...
namespace Earshot.Proximity
{
    ...
    public class VoiceRuntime : MonoBehaviour
    {
        ...
        /// <summary>
        /// Ersetzt den Ort, an dem zugehoert wird. Siehe <see cref="ProxVoice.ListenerOverride"/>.
        /// </summary>
        ...
        internal static VoiceRuntime EnsureExists()
        {
            ...
            var go = new GameObject("Proximity Voice");
        ...
        internal void AttachBackend(IVoiceBackend value)
        {
            ...
            ProxVoiceRoster.IdentityReady += OnIdentityReady;
        }
        ...
        private void OnSpeakerAdded(VoiceSpeaker speaker)
        {
            ...
            var profile = ProxVoiceSettings.Instance.VoiceProfile;
        ...
        private void OnIdentityReady(ProxVoicePlayer player)
        {
            ...
            if (byPlayerId.TryGetValue(player.PlayerId, out var emitter) && emitter != null)
            {
                ...
                ProxLog.Info($"Stimme von {player.DisplayName} ihrem Avatar zugeordnet.");
        ...
        private void TryBindEmitter(VoiceEmitter emitter)
        {
            ...
            if (ProxVoiceRoster.TryGetByPlayerId(emitter.PlayerId, out var matched) &&
            ...
            ProxVoicePlayer fallback = null;
            var players = ProxVoiceRoster.Players;
        ...
        private bool IsPlayerBound(ProxVoicePlayer player)
        {
        ...
        private bool TryGetListenerPosition(out Vector3 position)
        {
            ...
            // Laufen nicht.
            var local = ProxVoiceRoster.LocalPlayer;
            if (local != null)
            {

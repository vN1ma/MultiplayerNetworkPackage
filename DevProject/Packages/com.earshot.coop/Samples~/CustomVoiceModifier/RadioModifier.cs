...
namespace Earshot.Samples
{
    ...
    /// </para>
    /// <para>
    /// Verwendung: Asset anlegen ueber Create > Earshot > Samples > Radio, dann in ein
    /// VoiceProfile ziehen. Zum Abschalten das Haekchen am Asset oder das Asset aus dem
    /// Profil nehmen - Paketcode aendern ist nicht noetig.
    /// </para>
    /// </summary>
    [CreateAssetMenu(
        menuName = "Earshot/Samples/Radio",
    ...
    public class RadioModifier : VoiceModifierAsset
    {
        ...
        {
            // Bewusst keine Entfernung: Funk ignoriert den Raum dazwischen.
            sample.Muted = false;
